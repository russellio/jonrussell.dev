...
return [
     ...
     */
    'directives' => [
        [Spatie\Csp\Directive::DEFAULT, ['self']],
        [Spatie\Csp\Directive::SCRIPT, ['self', 'https://challenges.cloudflare.com', 'nonce', 'unsafe-eval']],
        [Spatie\Csp\Directive::CONNECT, ['self', 'https://challenges.cloudflare.com']],
        [Spatie\Csp\Directive::FRAME, ['self', 'https://challenges.cloudflare.com']],
        [Spatie\Csp\Directive::STYLE, ['self', 'unsafe-inline', 'https://challenges.cloudflare.com']],
        [Spatie\Csp\Directive::IMG, ['self', 'data:', 'https://challenges.cloudflare.com']],
        [Spatie\Csp\Directive::FONT, ['self', 'data:']],
    ],
